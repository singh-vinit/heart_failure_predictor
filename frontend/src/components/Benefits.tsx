  ...
  return (
    <section className="py-16 bg-blue-50">
      <div className="container px-4 mx-auto">
        <h2 className="text-3xl font-bold text-center text-blue-900 mb-4">Benefits</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <HeartPulse className="h-10 w-10 text-blue-600 mb-4" />
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Improved Patient Outcomes</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Reduced Readmission Rates</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <ChartBar className="h-10 w-10 text-blue-600 mb-4" />
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Cost Savings</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <Calendar className="h-10 w-10 text-blue-600 mb-4" />
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Resource Optimization</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <HeartPulse className="h-10 w-10 text-blue-600 mb-4" />
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Regulatory Compliance</h3>
            <p className="text-gray-600">
